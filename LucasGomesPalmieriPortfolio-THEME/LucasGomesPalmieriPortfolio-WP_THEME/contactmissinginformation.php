<?php /**
* Template Name: Contact Missing Informations Page!
*/ ?>
    ...
    <form class="form-contact" action="../enviaremail.php" method="post">
      ...
      <div class="form-group row form-row">
        <div class="col form-col contact-info">
          <p class="contact-missing-Information">Error: Missing Information!</p>
          <p class="contact-error-info">Please complete all the lacuns to send the message!</p>
        </div>
